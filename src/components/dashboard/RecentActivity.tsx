      ...
      <ul className="mt-4 divide-y divide-zinc-800">
        {recentActivity.map((item) => {
          ...
          return (
            ...
            >
              <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-zinc-800 text-zinc-300 transition-colors duration-200 group-hover:bg-indigo-500/10 group-hover:text-indigo-400">
